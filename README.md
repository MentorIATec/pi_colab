...
Al terminar el componente síncrono, cada estudiante deberá contar con:

- una intención inicial de aprendizaje;
- tres criterios indispensables para evaluar alternativas;
- una lista de información por investigar o confirmar;
...
**Sprint 1 — Diseño de la experiencia: en curso.**
...
- [Cadena de sprints](docs/SPRINTS.md)
- [Propuesta ejecutiva de colaboración](docs/sprint-0/PROPOSAL.md)
...
> La sesión no elige el intercambio por el estudiante. Le enseña a formular
> qué busca, evaluar opciones con evidencia y saber qué debe validar, con quién
> y cuándo.
